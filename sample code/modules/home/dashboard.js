MPortal.dashboard = function (params) {
    //"use strict";
    var db = openDatabase('mportalglico', '1.0', 'local database', 51200);

    $(document).ready(function () {
        //alert(params.id);
        if (params.id == "6" || params.id == 6 || (params.id == 1 && MPortal.is_logged == 0)) {
            MPortal.is_logged = 0;
        } else {
            MPortal.is_logged = 1;
        }
    ...
    var viewModel = {
        ...
        viewShown: function () {
            ...
            if (MPortal.is_logged == 0) {
                ...
                MPortal.config.navigation[4].visible(true);
        ...
        gotoBuy: function () {
            viewModel.navigateForward("buy_a_policy", "");
        }
